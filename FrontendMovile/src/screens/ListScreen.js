...
const ListScreen = ({ setScreen }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Button style={styles.button} color="purple" title="➕ Añadir producto y/o solicitud" onPress={() => setShowForm(true)}/>
                    ...
                    <View style={styles.card}>
                        {editingProduct === item.id ? (
                            <>
                                ...
                                <Button style={styles.button} title="Cancelar" color="red" onPress={() => setEditingProduct(null)}/>
                            </>
                        ) : (
                            <>
